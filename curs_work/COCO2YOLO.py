...
class COCO2YOLO:
    def __init__(self):
        ...
        self.person_category_ids = self._get_person_category_ids()
    ...
    def _get_person_category_ids(self):
        person_category_ids = []
        for cls in self.labels['categories']:
            if cls['supercategory'] == 'person':
                person_category_ids.append(cls['id'])
    ...
    def _convert_anno(self, images_info):
        ...
        for anno in self.labels['annotations']:
            ...
            # Проверяем, относится ли категория к 'person'
            if category_id not in self.person_category_ids:
                continue
